        ...
        33: [function (e, n, r) {
            (function (e) {
                !function (o) {
                    ...
                    var l = "object" == typeof r && r, d = "object" == typeof n && n && n.exports == l && n,
                        y = "object" == typeof e && e;
                    ...
                    if ("function" == typeof t && "object" == typeof t.amd && t.amd) t(function () {
                        ...
                        var k = {}, x = k.hasOwnProperty;
                        for (var A in w) x.call(w, A) && (l[A] = w[A])
                    } else o.utf8 = w
                }(this)
            }).call(this, "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {}],
                ...
                if (!n("json")) {
                    ...
                    if (!n("json-parse")) {
                        var P, R, N = String.fromCharCode,
                            ...
                            q = function () {
                                ...
                                if ("$" == t && q(), "string" == typeof t) {
                                    ...
                                    if ("[" == t) {
                                        for (e = []; t = D(), "]" != t; n || (n = !0)) n && ("," == t ? (t = D(), "]" == t && q()) : q()), "," == t && q(), e.push(U(t));
                                        return e
                                    }
                                    if ("{" == t) {
                                        for (e = {}; t = D(), "}" != t; n || (n = !0)) n && ("," == t ? (t = D(), "}" == t && q()) : q()), ("," == t || "string" != typeof t || "@" != (b ? t.charAt(0) : t[0]) || ":" != D()) && q(), e[t.slice(1)] = U(D());
                                        return e
                                    }
                                    q()
                                }
                        ...
                        u.parse = function (t, e) {
                            var n, r;
                            return P = 0, R = "" + t, n = U(D()), "$" != D() && q(), P = R = null, e && a.call(e) == l ? L((r = {}, r[""] = n, r), "", e) : n
                        }
                    }
                }
                c && t(function () {
